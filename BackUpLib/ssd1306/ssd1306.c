...
void PrintIcon (char *icon, uint16_t W, uint16_t H, uint16_t NX, uint16_t NY)
{
	...
	while (Y<H)
	{
				if (icon[count]&0x80)
				{
						SSD1306_DrawPixel(X+NX, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x40)
				{
						SSD1306_DrawPixel(X+NX+1, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x20)
				{
						SSD1306_DrawPixel(X+NX+2, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x10)
				{
						SSD1306_DrawPixel(X+NX+3, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x08)
				{
						SSD1306_DrawPixel(X+NX+4, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x04)
				{
						SSD1306_DrawPixel(X+NX+5, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x02)
				{
						SSD1306_DrawPixel(X+NX+6, Y+NY, SSD1306_COLOR_WHITE);
				}
				if (icon[count]&0x01)
				{
						SSD1306_DrawPixel(X+NX+7, Y+NY, SSD1306_COLOR_WHITE);
				}
				X+=8;
				count++;
				if ((X)>=W)
